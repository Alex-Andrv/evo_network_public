...
task_name = "watts_strogatz&uniform_1-2&const_0.8&40&8&0.5&123"
solver_name, run_script = ("tdg_1+1[10000]", lambda problem, seed: problem.solve_using_tdg_and_then_1p1(None, None, tss_stop_criteria.by_iteration_count(10000), seed=seed))
