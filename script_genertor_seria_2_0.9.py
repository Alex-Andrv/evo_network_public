...
run_script_template = """
    sbatch --cpus-per-task=2 --mem=20G -p as --time=20:00:00 -w orthrus-1 --qos=high_cpu --qos=high_mem --qos=unlim_cpu "generate/{}/{}"
"""
...
if __name__ == '__main__':
    ...
    tss = TSSProblem(dltm, dltm.nodes_count() * 0.9)
...
if __name__ == '__main__':
 solvers = [
     ...
     ('tdg_iter_descent[5000, 1]',
      "lambda problem, seed: problem.solve_using_tdg_and_then_iter_descent(None, None, tss_stop_criteria.by_iteration_count(5000), 1, seed)"),
     ('tdg_iter_descent[5000, 2]',
      "lambda problem, seed: problem.solve_using_tdg_and_then_iter_descent(None, None, tss_stop_criteria.by_iteration_count(5000), 2, seed)"),
     ('tdg_iter_descent[5000, 5]',
      "lambda problem, seed: problem.solve_using_tdg_and_then_iter_descent(None, None, tss_stop_criteria.by_iteration_count(5000), 5, seed)"),
     ('tdg_iter_descent_v2[5000, 1]',
      "lambda problem, seed: problem.solve_using_tdg_and_then_iter_descent_v2(None, None, tss_stop_criteria.by_iteration_count(5000), 1, seed)"),
     ('tdg_iter_descent_v3[5000, 1]',
      "lambda problem, seed: problem.solve_using_tdg_and_then_iter_descent_v3(None, None, tss_stop_criteria.by_iteration_count(5000), 1, seed)"),
    ('tdg_iter_descent_v4[5000, 1]',
      "lambda problem, seed: problem.solve_using_tdg_and_then_iter_descent_v4(None, None, tss_stop_criteria.by_iteration_count(5000), 1, seed)"),
  ]
