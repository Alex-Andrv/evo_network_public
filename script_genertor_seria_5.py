...
run_script_template = """
    sbatch --cpus-per-task=2 --mem=20G --time=20:00:00 -w orthrus-1 --qos=high_cpu --qos=high_mem --qos=unlim_cpu "generate/{}/{}"
"""
...
if __name__ == '__main__':
 solvers = [
    ('tdg_iter_descent_v4[10000, 1, 25]',
      "lambda problem, seed: problem.solve_using_tdg_and_then_iter_descent_v4(None, None, tss_stop_criteria.by_iteration_count(10000), 1, 25, seed)"),
        ('tdg_iter_descent_v4[10000, 1, 50]',
      "lambda problem, seed: problem.solve_using_tdg_and_then_iter_descent_v4(None, None, tss_stop_criteria.by_iteration_count(10000), 1, 50, seed)"),
          ('tdg_iter_descent_v4[10000, 1, 75]',
      "lambda problem, seed: problem.solve_using_tdg_and_then_iter_descent_v4(None, None, tss_stop_criteria.by_iteration_count(10000), 1, 75, seed)"),
          ('tdg_iter_descent_v4[10000, 1, 100]',
      "lambda problem, seed: problem.solve_using_tdg_and_then_iter_descent_v4(None, None, tss_stop_criteria.by_iteration_count(10000), 1, 100, seed)"),
          ('tdg_iter_descent_v4[10000, 1, 125]',
      "lambda problem, seed: problem.solve_using_tdg_and_then_iter_descent_v4(None, None, tss_stop_criteria.by_iteration_count(10000), 1, 125, seed)"),
